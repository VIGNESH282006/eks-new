...
export const StickyScroll = ({
    ...
    return (
        <motion.div
            animate={{
                backgroundColor: "white", // Keeping it clean white for this project
            }}
                    ...
                    {content.map((item, index) => (
                        <div key={item.title + index} className="my-20">
                            <motion.h2
                                ...
                                className="text-2xl font-bold text-slate-800" // Adjusted for light mode
                            >
                                {item.title}
                            </motion.h2>
                            <motion.p
                                ...
                                className="text-kg text-slate-600 max-w-sm mt-10" // Adjusted for light mode
                            >
                                {item.description}
                            </motion.p>
                        </div>
