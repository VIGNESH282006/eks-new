...
export const Footer = () => {
    ...
    return (
        <footer className="-mt-32 mb-0 px-4 w-full text-base-content mx-auto">
            ...
            <div className="relative bg-gradient-to-br from-slate-900 via-[#082E6D] to-slate-800 rounded-3xl w-full mx-auto px-10 py-12 flex flex-col gap-8 shadow-lg overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-6 px-2 md:px-8 w-full">
                    ...
                    <div className='flex flex-col md:flex-row gap-6 md:gap-12 items-start justify-start flex-1'>
                        ...
                        <div className='flex flex-col gap-1 md:gap-4'>
                            ...
                            <div className="flex flex-wrap md:flex-col gap-2 text-sm text-white items-start">
                        ...
                        <div className='flex flex-col gap-1 md:gap-4 ml-auto'>
                            ...
                            <div className="flex gap-2 flex-wrap md:flex-col text-sm text-white items-start">
